      ...
      <div className="py-16">
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="text-center">
            <img src={feature1img} alt="AI Mock Interviews" className="w-full max-w-md mx-auto" />
          ...
          <div className="text-center">
            <img src={feature2img} alt="Smart Feedback Report" className="w-full max-w-md mx-auto" />
          ...
          {/* Smart Chatbot Guide */}
          <div className="text-center">
            <img src={feature3img} alt="Smart Chatbot Guide" className="w-full max-w-md mx-auto" />
