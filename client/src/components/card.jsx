...
const JobCard = () => {
  return (
    <div className="bg-[#022b3a] text-white shadow-md rounded-lg p-10 w-1/4 m-2 ml-10 " style={{ height: '38vh' }}>
      <div className="mb-2 ">
        <h2 className="text-lg font-bold">{`Company name`}</h2>
        {/* { <img src={`company logo`} alt="Company Logo" className="h-12 w-auto" /> } */}
      </div>
      <p className="text-gray-300 mb-2">{`for what role`}</p>
      <div className="flex items-center mb-2">
        <svg className="h-5 w-5 text-gray-400 mr-2" fill="currentColor" viewBox="0 0 20 20">
          <path d="M9 12a5 5 0 100-10 5 5 0 000 10z" />
        </svg>
        <span className="text-gray-300">{`skills required`}</span>
      </div>
      <div className="flex items-center mb-2">
        <svg className="h-5 w-5 text-gray-400 mr-2" fill="currentColor" viewBox="0 0 20 20">
